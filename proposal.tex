...
Users wilt bulk needs will use BPS (\secref{sec:bpsbatch})
...
Users needing batch will need to go via the Resource Allocation Committee (\secref{sec:allocation}) and
